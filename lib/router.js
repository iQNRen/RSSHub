...
// 自定义
router.get('/fujian/jyt/:type', lazyloadRouteHandler('./routes/_Custom/jyt/'));
router.get('/jszp/:type', lazyloadRouteHandler('./routes/_Custom/jszp/'));
router.get('/gwy', lazyloadRouteHandler('./routes/_Custom/gwy/'));
router.get('/gwy/guangdong', lazyloadRouteHandler('./routes/_Custom/gwy/guangdong/'));
...
// 泉州师范学院
router.get('/qztc/home/:type', lazyloadRouteHandler('./routes/universities/qztc/home'));
router.get('/qztc/jwc/:type', lazyloadRouteHandler('./routes/universities/qztc/jwc'));
router.get('/qztc/sjxy/:type', lazyloadRouteHandler('./routes/universities/qztc/sjxy'));
