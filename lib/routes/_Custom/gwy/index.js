// 可以一次获取全部数据，但比较慢，服务器压力大。容易运行失败
const got = require('@/utils/got');

const articleApi = 'http://dl.scs.gov.cn/api/article/' // 文章
const apiMap = {
    '招考公告': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bccdd5860007/1?_=1736156651242', // 招考公告
    '重要公告': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcce3de20008/1?_=1736175454275', // 重要公告
    '政策法规': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcd1a324000d/1?_=1736175589199', // 政策法规
    '考务问答': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcd32bfe0011/1?_=1736175648339', // 考务问答
    '政策问答': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcd29fcf000f/1?_=1736175681157', // 政策问答
    '技术问答': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcd2e8f70010/1?_=1736175752758', // 技术问答
    '录用公告': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bcd0591c000b/1?_=1736175826283', // 录用公告
    '面试公告': 'http://dl.scs.gov.cn/api/article/articlelist/all/8a81f6d09024e05b01914fc92ed90023/0000000062b7b2b60162bccf480c000a/1?_=1736175784949' // 面试公告
};
...
module.exports = async (ctx) => {
    ...
    const fetchTasks = Object.entries(apiMap).map(async ([type, link]) => {
        ...
        const list = $.map((item, index) => {
            ...
            return {
                title: `[${type}]-` + item.articleTitle.trim() || '',
                link: itemLink,
                apiLink: apiLink,
